...
GO
CREATE PROCEDURE DP_RAPOR_VADETARIHLIBORC @DB NVARCHAR(50), @FIRM NVARCHAR(3), @DONEM NVARCHAR(2) ,
...
select C.CODE AS [Cari Hesap Kodu],c.DEFINITION_ as [Cari Hesap Ünvanı],c.SPECODE as [Özel Kod],b.B_TUTAR as [Tutar] ,year(b.B_VADE_TARIHI) as [Yıl],MONTH(b.B_VADE_TARIHI) as [Ay],b.B_VADE_TARIHI as [Vade Tarihi]
