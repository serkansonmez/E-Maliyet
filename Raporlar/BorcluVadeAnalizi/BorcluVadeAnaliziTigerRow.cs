...
namespace E_Go.Raporlar.Entities
{
    ...
    [ConnectionKey("Tiger"), Module("Raporlar"), TableName("[dbo].[BorcluVadeAnaliziTigerRow]")]
    [DisplayName("Borclu Vade Analizi"), InstanceName("Borclu Vade Analizi")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    public sealed class BorcluVadeAnaliziTigerRow : Row, IIdRow, INameRow
    {
        ...
        public BorcluVadeAnaliziTigerRow()
            : base(Fields)
        {
        }
