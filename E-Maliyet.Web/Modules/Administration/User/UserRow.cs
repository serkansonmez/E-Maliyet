...
namespace E_Maliyet.Administration.Entities
{
  ...
  //  [LookupScript(Permission = PermissionKeys.Security )]
    ...
    public sealed class UserRow : LoggingRow, IIdRow, INameRow, IIsActiveRow
    {
        ...
        [DisplayName("Firma"), ForeignKey(typeof(TigerFirmalarRow)), LeftJoin("jTigerFirmalar"), LookupInclude]
        [LookupEditor(typeof(TigerFirmalarRow))]
        //[DisplayName("TigerFirma"), Size(100)]
        public String TigerFirma
        {
            get { return Fields.Email[this]; }
            set { Fields.Email[this] = value; }
        }
        [DisplayName("TigerDonem"), Size(100)]
        ...
        [DisplayName("Firma Adi"), Expression("jTigerFirmalar.[NAME]")]
        public String TigerFirmaAdi
        {
            get { return Fields.TigerFirmaAdi[this]; }
            set { Fields.TigerFirmaAdi[this] = value; }
        }

        [DisplayName("Dönem No"), Expression("jTigerFirmalar.[NR]")]
        public String TigerDonemNo
        {
            get { return Fields.TigerDonemNo[this]; }
            set { Fields.TigerDonemNo[this] = value; }
        }
        ...
        public class RowFields : LoggingRowFields
        {
            ...
            public StringField TigerFirmaAdi;
            public StringField TigerDonemNo;
        }
    }
}